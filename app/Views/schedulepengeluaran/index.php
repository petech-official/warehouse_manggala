    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <!-- Tambah data -->
                <div class="card-body">
                    <h4>Jadwal Pengeluaran Barang (Schedule)</h4>
                    <hr>
                            ...
                            foreach ($data as $key => $value) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" href='#modalHapus' onclick="konfirmasiDelete(<?= $value['id_schedule_pengeluaran']; ?>)" class="btn btn-danger" data-toggle="modal">
